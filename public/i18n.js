...
OWN.ru = {
  ...
  fd_referral_off_path: 'Сервер отправил нас в зону, которая не является предком запрошенного имени. Это ошибка конфигурации, и следовать такой отсылке — способ оказаться не там.',
