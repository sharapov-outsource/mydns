...
OWN.uk = {
  ...
  fd_referral_off_path: 'Сервер відправив нас у зону, яка не є предком запитаного імені. Це помилка налаштування, і піти за таким відсиланням — певний спосіб опинитися не там.',
